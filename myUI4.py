...
sample_image = cv2.imread("/home/yoona/Pictures/118942542_1677807779057284_2706372375009162374_n.jpg")
image_result = [sample_image] * 4
feature = {
    'car1': False,
    'mpa1': True,
    'person1': True,
...
class Ui_MainWindow(QWidget): 
 ...
 # View CAM 1
        ...
        self.CAM1.setMinimumSize(QtCore.QSize(700, 350))
        self.CAM1.setMaximumSize(QtCore.QSize(900, 400))
 ...
 # View CAM 2
        ...
        self.CAM2.setMinimumSize(QtCore.QSize(700, 350))
        self.CAM2.setMaximumSize(QtCore.QSize(900, 400))
 ...
 # View CAM 3
        ...
        self.CAM3.setMinimumSize(QtCore.QSize(700, 350))
        self.CAM3.setMaximumSize(QtCore.QSize(900, 400))
 ...
 # View CAM 4
        self.CAM4 = QtWidgets.QLabel(self.tab)
        self.CAM4.setMinimumSize(QtCore.QSize(700, 350))
        self.CAM4.setMaximumSize(QtCore.QSize(900, 400))
        self.CAM4.setFrameShape(QtWidgets.QFrame.Box)
        self.CAM4.setObjectName("CAM4")
        self.verticalLayout_22.addWidget(self.CAM4)
        self.horizontalLayout_44 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_44.setObjectName("horizontalLayout_44")
        self.startCAM4 = QtWidgets.QPushButton(self.tab)
        self.startCAM4.setObjectName("startCAM4")
        self.horizontalLayout_44.addWidget(self.startCAM4)
        self.carProtectionCAM4 = QtWidgets.QPushButton(self.tab)
        self.carProtectionCAM4.setObjectName("carProtectionCAM4")
        self.horizontalLayout_44.addWidget(self.carProtectionCAM4)
        self.monitorAreaCAM4 = QtWidgets.QPushButton(self.tab)
        self.monitorAreaCAM4.setObjectName("monitorAreaCAM4")
        self.horizontalLayout_44.addWidget(self.monitorAreaCAM4)
        self.verticalLayout_22.addLayout(self.horizontalLayout_44)
        self.horizontalLayout_55 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_55.setObjectName("horizontalLayout_55")
        self.stopCAM4 = QtWidgets.QPushButton(self.tab)
        self.stopCAM4.setEnabled(False)
        self.stopCAM4.setObjectName("stopCAM4")
        self.horizontalLayout_55.addWidget(self.stopCAM4)
        self.personSearchingCAM4 = QtWidgets.QPushButton(self.tab)
        self.personSearchingCAM4.setObjectName("personSearchingCAM4")
        self.horizontalLayout_55.addWidget(self.personSearchingCAM4)
        self.illegalCAM4 = QtWidgets.QPushButton(self.tab)
        self.illegalCAM4.setObjectName("illegalCAM4")
        self.horizontalLayout_55.addWidget(self.illegalCAM4)
        self.verticalLayout_22.addLayout(self.horizontalLayout_55)
        self.gridLayout.addLayout(self.verticalLayout_22, 1, 1, 1, 1)
        self.tabWidget.addTab(self.tab, "")
 # Media Tab
 ...
 # Setting CAM 1
        ...
        self.CAM1_draw.setMinimumSize(QtCore.QSize(700, 320))
        self.CAM1_draw.setMaximumSize(QtCore.QSize(900, 400))
 ...
 # Setting CAM 2
        ...
        self.CAM2_draw.setMinimumSize(QtCore.QSize(700, 320))
        self.CAM2_draw.setMaximumSize(QtCore.QSize(900, 400))
 ...
 # Setting CAM 3 
        ...
        self.CAM3_draw.setMinimumSize(QtCore.QSize(700, 320))
        self.CAM3_draw.setMaximumSize(QtCore.QSize(900, 400))
 ...
 # Setting CAM 4
        self.CAM4_draw = QtWidgets.QLabel(self.tab_3)
        self.CAM4_draw.setMinimumSize(QtCore.QSize(700, 320))
        self.CAM4_draw.setMaximumSize(QtCore.QSize(900, 400))
        self.CAM4_draw.setFrameShape(QtWidgets.QFrame.Box)
        self.CAM4_draw.setObjectName("CAM4_draw")
        self.verticalLayout_77.addWidget(self.CAM4_draw)
        self.horizontalLayout_122 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_122.setObjectName("horizontalLayout_122")
        self.drawCAM4 = QtWidgets.QPushButton(self.tab_3)
        self.drawCAM4.setObjectName("drawCAM4")
        self.horizontalLayout_122.addWidget(self.drawCAM4)
        self.removeCAM4 = QtWidgets.QPushButton(self.tab_3)
        self.removeCAM4.setObjectName("removeCAM4")
        self.horizontalLayout_122.addWidget(self.removeCAM4)
        self.verticalLayout_77.addLayout(self.horizontalLayout_122)
        self.gridLayout_2.addLayout(self.verticalLayout_77, 1, 1, 1, 1)
        self.tabWidget.addTab(self.tab_3, "")
        self.verticalLayout_4.addWidget(self.tabWidget)
 ...
 # Setup Connect
    # Setup enable
        ...
        self.removeCAM4.setEnabled(False)
    # Setup choosing feature
        ...
        self.carProtectionCAM4.setVisible(self.feature['car4'])       
        ...
        self.illegalCAM4.setVisible(self.feature['illegal4'])
        ...
        self.monitorAreaCAM4.setVisible(self.feature['mpa4'])
        self.monitorAreaCAM4.toggle()
        self.monitorAreaCAM4.setCheckable(True)
        ...
        self.personSearchingCAM4.setVisible(self.feature['person4'])
    ...
    # setup image processing
        ...
        self.startCAM4.clicked.connect(self.start_view4)
        self.stopCAM4.clicked.connect(self.stop_view4)
        ...
        self.CAM4_draw.mousePressEvent = self.mouseEventCAM4
        ...
        self.drawCAM4.clicked.connect(self.startDrawAreaCAM4)
        self.removeCAM4.clicked.connect(self.removeAreaCAM4)
 ...
 # Function retranslateUI
    def retranslateUi(self, Form):
        ...
        self.CAM4.setText(_translate("Form", "IP CAM 4"))
        self.startCAM4.setText(_translate("Form", "Start"))
        self.carProtectionCAM4.setText(_translate("Form", "Car protection"))
        self.monitorAreaCAM4.setText(_translate("Form", "Monitor prohibited area"))
        self.stopCAM4.setText(_translate("Form", "Stop"))
        self.personSearchingCAM4.setText(_translate("Form", "Person searching"))
        self.illegalCAM4.setText(_translate("Form", "Illegal access action"))
        ...
        self.CAM4_draw.setText(_translate("Form", "TextLabel"))
        self.drawCAM4.setText(_translate("Form", "Draw"))
        self.removeCAM4.setText(_translate("Form", "Clear"))
 ...
 # Function for image processing
    ...
    def start_view4(self):
        self.stopCAM4.setEnabled(True)
        self.startCAM4.setEnabled(False)
        global image_result
        if True:
            self.check4 = False
            self.warning4 = None
            now = datetime.now()
            self.savePath4 = self.createDir('IP_CAM_4')
            self.startTime4 = str(now.day)+' - '+str(now.hour)+'h'+str(now.minute)+ ' - '
            fourcc = cv2.VideoWriter_fourcc(*'XVID')
            self.outVivdeo4 = cv2.VideoWriter(self.savePath4+'output4.avi', fourcc, 30, (int(image_result[3].shape[1]), int(image_result[3].shape[0])))
    ...
    def viewCam4(self):
      global image_result
      image = image_result[3].copy()
      self.outVivdeo4.write(image)
      flag_warning = 0
      if self.monitorAreaCAM4.isChecked():
          flag_warning = myLib.monitorProhibitedArea(points=self.points_CAM4, center_point=myLib.center_point, source_id=3)
          if self.warning4 is not None:
              self.warning4.warning_flag = flag_warning
          if flag_warning == None and self.check4 == False:
            pass
          elif flag_warning == 1 and self.check4 == False:
            print("warning camera 4")
            self.check4 = True
            self.warning4 = warningMethod(camera_idx=4, warning_flag=flag_warning, type_warning=1)
            self.t4 = threading.Thread(target=self.warning4.run, args=())
            self.t4.start()
        #   elif self.check3 == True and flag_warning == None:
        #     print("terminate camera 2")
        #     self.warning3.terminate()
        ...
        if self.warning4 is not None:
          self.warning4.terminate()
          del self.warning4
          self.warning4 = None
          print("Delete Thread Warning Camera 4")
          self.check4 = False
      self.CAM4.setPixmap(QPixmap.fromImage(self.image_to_QImage(image, self.CAM4)))
      self.CAM4_draw.setPixmap(QPixmap.fromImage(self.image_to_QImage(self.drawArea(image, self.points_CAM4, self.CAM4_draw, flag_warning), self.CAM4_draw)))             
    def stop_view4(self):
        self.startCAM4.setEnabled(True)
        self.stopCAM4.setEnabled(False)    
        self.timer4.stop()
        self.outVivdeo4.release()
        image = cv2.imread('stopVideo.png')
        self.CAM4.setPixmap(QPixmap.fromImage(self.image_to_QImage(image, self.CAM4)))
        now = datetime.now()
        fileName = self.startTime4+str(now.hour)+'h'+str(now.minute)+'.avi'
        os.rename(self.savePath4+'output4.avi', self.savePath4+fileName)
        if self.warning4 is not None:
          self.warning4.terminate()
          self.check4 = False
    ...
    def mouseEventCAM4(self, event):
        if self.removeCAM4.isEnabled() and (not self.startCAM4.isEnabled()) == True:
            x = event.pos().x()
            y = event.pos().y()
            print(x, y)
            x = round((x/self.CAM4_draw.width()), 10)
            y = round((y/self.CAM4_draw.height()), 10)
            self.points_CAM4.append([x, y])
            print("Position clicked is ({}, {})".format(int(x*self.CAM4_draw.width()), int(y*self.CAM4_draw.height())))
    ...
    def startDrawAreaCAM4(self):
        self.drawCAM4.setEnabled(False)
        self.removeCAM4.setEnabled(True)

    def removeAreaCAM4(self):
        while len(self.points_CAM4):
            self.points_CAM4.pop()
        self.drawCAM4.setEnabled(True)
        self.removeCAM4.setEnabled(False)
...
class Ui_Form(object):
    def openNewWindow(self):
        ...
        'car4': self.carCAM3.isChecked(),
        'mpa4': self.monitorCAM3.isChecked(),
        'person4': self.personSearchingCAM3.isChecked(),
        'illegal4': self.illegalCAM3.isChecked()
        }
